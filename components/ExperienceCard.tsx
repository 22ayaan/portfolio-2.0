...
function ExperienceCard({}: Props) {
  return (
    ...
    cursor-pointer transition-opacity durattion-200 overflow-hidden'>
      <motion.img
        initial={{
          y: -100,
          opacity: 0
        ...
        src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTZqd46wqMXcv_1xhaw15wGRuBjUVcpdgPcA&usqp=CAU'
        alt=''
        className='h-32 w-32 rounded-full object-cover object-center md:rounded-full xl:w-[200px] xl:h-[200px]'
      />
      ...
      <div className='px-0'>
        ...
        <p className='uppercase py-5 text-gray-500'>start date - end date</p>
